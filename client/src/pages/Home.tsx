        ...
        <div className="relative z-10 max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8 mb-12">
            ...
            <div className="p-6 border-2 border-primary bg-background/50 hover:bg-background/80 transition-colors">
              <div className="mb-6">
                <img 
                  src="https://files.manuscdn.com/user_upload_by_module/session_file/310519663349269149/kxdrqwDcqnHwiSEN.png"
                  alt="Wide View"
            ...
            <div className="p-6 border-2 border-secondary bg-background/50 hover:bg-background/80 transition-colors">
              <div className="mb-6">
                <img 
                  src="https://files.manuscdn.com/user_upload_by_module/session_file/310519663349269149/fcZsriYfiGhtKKHb.png"
                  alt="Near View"
