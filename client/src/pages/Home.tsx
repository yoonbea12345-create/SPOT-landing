        ...
        <div className="max-w-4xl mx-auto">
          <div className="space-y-12 text-center">
            <p className="text-3xl md:text-5xl font-black leading-tight">
              <span className="text-secondary glow-magenta">핫플은 알지만 거기<br />
              <span className="text-secondary glow-magenta">누가</span> 있는지는 모릅니다.
            </p>

            <p className="text-3xl md:text-5xl font-black leading-tight">
              지금 <span className="text-secondary glow-magenta">여기, <span className="text-secondary glow-magenta">어떤</span> 사람들이<br />
              있는지도 모릅니다.
            </p>

            <p className="text-3xl md:text-5xl font-black leading-tight">
              <span className="text-secondary glow-magenta">어디</span>인지는 알지만<br />
              <span className="text-secondary glow-magenta">누가있는지는 모릅니다.
            </p>
